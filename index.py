...
def inserir():
    ...
    if nome == '':
        messagebox.showerror('Error','O campo não pode está vazio')
    else:
...
#nome
l_nome=Label(frame_baixo,text='Nome *',anchor=NW,font=('Ivy 10'),bg=co1,fg=co4,relief='flat')
...
#data consulta
l_dataconsulta=Label(frame_baixo,text='Data da Consulta *',anchor=NW,font=('Ivy 10 bold'),bg=co1,fg=co4,relief='flat')
l_dataconsulta.place(x=15,y=190)
e_dataconsulta=DateEntry (frame_baixo,width=12,Background='darkblue',foreground='white',borderwidth=2,year=2022)
...
#sobre
l_sobre=Label(frame_baixo,text='Assunto *',anchor=NW,font=('Ivy 10 bold'),bg=co1,fg=co4,relief='flat')
